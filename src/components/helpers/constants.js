...
export const fallbackCoverImgRest = 'https://placehold.co/384x250';
export const fallbackCoverImgMeal = 'https://placehold.co/384x215';
export const data = {
  restaurants: [
    {
      id: 0,
      name: 'Pizza Plus',
      logoImg: 'src/assets/restaurants/pizzaplus.jpg',
      rating: 4.5,
      meals: ['pizza'],
    ...
    },
    {
      id: 1,
      name: 'Tanuki',
      logoImg: 'src/assets/restaurants/tanuki.jpg',
      rating: 4.8,
      meals: ['pizza', 'sushi'],
      averageOrderTime: '50 min',
      minMealPrice: 9,
      stock: [
        {
          ...
          photo: 'src/assets/goods/image-001.jpg',
        ...
        },
        {
          ...
          photo: 'src/assets/goods/image-002.jpg',
        ...
        },
        {
          ...
          photo: 'src/assets/goods/image-003.jpg',
        ...
        },
        {
          id: 3, 
          article: 'Caesar XL',
          photo: 'src/assets/goods/image-004.jpg',
        ...
        },
        {
          ...
          photo: 'src/assets/goods/image-005.jpg',
        ...
        },
        {
          ...
          photo: 'src/assets/goods/image-006.jpg',
    ...
    },
    {
      id: 2,
      name: 'FoodBand',
      logoImg: 'src/assets/restaurants/foodband.jpg',
      rating: 3.5,
      meals: ['pizza'],
      ...
      stock: [
        ...
        },
        {
          id: 1,
          article: 'Proscutto di Fungi',
          photo: 'src/assets/goods/image-007.jpg',
          ingredients: 'Pizza dough, tomatoes, mozzarella, mushrooms, cooked ham',
          price: 33,
        }
      ]
    },
    {
      id: 3,
      name: 'Greedy Pizza',
      logoImg: 'src/assets/restaurants/greedy-pizza.jpg',
      rating: 5.5,
      meals: ['pizza'],
    ...
    },
    {
      id: 4,
      name: 'Food Point',
      logoImg: 'src/assets/restaurants/foodpoint.jpg',
      rating: 3.2,
      meals: ['pizza'],
      averageOrderTime: '50 min',
      minMealPrice: 9,
    ...
    },
    {
      id: 5,
      name: 'Pizza Burger',
      logoImg: 'src/assets/restaurants/pizzaburger.jpg',
      rating: 2,
      meals: ['pizza'],
      averageOrderTime: '50 min',
      minMealPrice: 9,
